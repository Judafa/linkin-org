...
The killer feature is that the links are *reliable*: your links keep taking you exactly to the right location, even as the linked data gets renamed, moved or modified (more details [[#how-reliable-are-the-links-exactly][here]]).
...
are guaranteed to keep working as long as you follow a few guidelines.


First, when you create the link.
