...
*** Just downloaded some file?
  ...
  This just copied a link: paste it in a .org file and follow the link (~linkin-org-open-link~) with your cursor on the it to retrieve your file.
...
*** Reading something interesting in a pdf?
  ...
  If the pdf file has an id then your link will always work: perfect for fast, reliable note taking.
