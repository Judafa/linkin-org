...
From a note, just follow a link that you previously pasted there to access a precise location of your file system: any file, a given place in a text file, precise words in a pdf, etc.
The killer feature of linkin-org is, links are *reliable*: your links keep working as the linked data gets renamed, moved or modified (precisions [[#how-reliable-are-the-links-exactly][here]]).
