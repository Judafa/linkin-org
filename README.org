...
Links are amazing: you can refer to any data from your written notes, making it easy to centralize and organize information.
The main problem is, a link stops working if the linked data changes its location or name, we say the link became broken.
