...
linkin-org turns your notes into precise, reliable access points towards your data: create, paste and follow a link to access a file, a precise line in a text file, precise words in a pdf.


The most important features of linkin-org:
- *reliable*: your links just wont break.
  It takes a bit of [[#how-reliable-are-the-links-exactly][discipline]], nothing painful.
- *fully distributed*: rename, move, modify your files from literally anywhere.
  Not modifying or removing the ids is all it takes.
- *simple*: 3 main commands, that's all you need.
...
- *First attach an id to the data, then create a link*.
...
- *Keep your data in sub-directories of* ~linkin-org-search-directories-to-resolve-broken-links~.
...
- Place the most relevant link at the top of the note.
  ...
  It can also be a link toward a precise place of the note itself --- for instance, my reading notes always start with a link that takes me to the end of the note; I then go one line up and follow the pdf link I pasted there last time I stopped reading to go where I was.
