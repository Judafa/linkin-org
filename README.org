...
Links are amazing: you can access any data directly from your written notes, making it so easy to organize and retrieve your files.
The main problem is, a link stops working if the linked data changes location or name, we say the link became broken.
As you want to rename or move your files over time, any linked-based systems is inherently fragile and thus unfit to access your data without mental overhead.
