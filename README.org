...
# [id:20250425T160020] link gets you there
  #+end_src
  You can rename your file (do not modify the id of course!), move, modify the file content (but not the ids inside!), your links will still works thanks to the id.
